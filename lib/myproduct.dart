import 'package:bai/api.dart';
import 'package:flutter/material.dart';
import 'package:bai/model/product.dart';
...
class _MyProductState extends State<MyProduct> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 75, 58, 444),
        title: Row(
          children: [
            Text(
              'Hana shop',
      ...
      bottomNavigationBar: BottomAppBar(
        color: const Color.fromARGB(255, 75, 58, 444),
        child: SizedBox(
          height: 30,
          child: Row(
